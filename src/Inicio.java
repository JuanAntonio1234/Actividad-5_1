...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mostrarListaPersonas = new javax.swing.JMenuItem();
        ...
        mostrarListaPersonas.setText("Mostrar lista personas");
        mostrarListaPersonas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mostrarListaPersonasActionPerformed(evt);
            }
        });
        opcionesPersona.add(mostrarListaPersonas);
    ...
    private void añadirPersonaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_añadirPersonaActionPerformed
        ...
        formPersonas = new panelCrearPersona(barraMenu);
    ...
    private void mostrarListaPersonasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mostrarListaPersonasActionPerformed
        barraMenu.setVisible(false);
        listaPersonas = new listaPersonas(barraMenu);
        listaPersonas.setVisible(false);
        this.getContentPane().add(listaPersonas);
        listaPersonas.setVisible(true);
        this.pack();
    }//GEN-LAST:event_mostrarListaPersonasActionPerformed
    ...
    private javax.swing.JMenuItem mostrarListaPersonas;
